...
pub use state::{
    ...
    OperationFailureKind, OwnProfile, PendingComposerSendKind, PinOp, PinOperationState,
    PinnedEvent, PresenceKind, ProfileState, ProfileUpdateRequest, ProfileUpdateState,
