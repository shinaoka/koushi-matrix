use koushi_state::RoomAttentionKind;

#[test]
fn room_attention_summary_from_counts_preserves_unread_fallback() {
    let summary = koushi_sdk::room_attention_summary_from_counts(
...
fn room_attention_summary_from_counts_prefers_dm_and_mentions() {
    let dm_summary = koushi_sdk::room_attention_summary_from_counts(
    ...
    let mention_summary = koushi_sdk::room_attention_summary_from_counts(
        Some("Direct".to_owned()),
        true,
        4,
        2,
