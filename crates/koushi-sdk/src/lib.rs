...
pub use room_operations::{
    ...
    MatrixSpaceMemberRoleUpdateResult, MatrixSpaceParentLinkOutcome, MatrixUserTrustState,
    accept_invited_room, cancel_space_invite, check_room_alias_availability,
