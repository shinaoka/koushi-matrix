...
| `avatar_demand` | dedicated 1,500-reader source, eight visible plus eight prefetch images, scoped PNGs, disjoint window move/return and cache reopen; requires `--core`, separate from `all` | `avatar_window_requests=ok` |
