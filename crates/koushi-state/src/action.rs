...
use crate::state::{
    ...
    LoginAttemptId, LoginFlow, MentionCandidate, MentionCandidatesCompleteness,
    MentionCandidatesFailureKind, MentionSurface, NativeAttentionDispatchId,
    NativeAttentionSoundOutcome, NativeAttentionState, NavigationPreferenceUpdate, NavigationState,
...
pub enum AppAction {
    ...
    CurrentSessionStatusRefreshFailed {
        request_id: u64,
    ...
    EventNavigationStarted {
        source: EventNavigationSource,
    },
    EventNavigationAnchored {
        generation: u64,
    },
    EventNavigationLiveFallback {
        generation: u64,
    },
