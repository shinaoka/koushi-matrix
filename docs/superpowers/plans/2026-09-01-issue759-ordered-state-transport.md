...
| desktop adapter update lifecycle | `getDesktopUpdateState`, `restartToInstallDesktopUpdate` | typed Tauri adapter state/action; no Core snapshot or renderer-owned lifecycle |
