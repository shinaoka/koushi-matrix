...
pub use room_operations::{
    ...
    accept_invited_room, cancel_space_invite, create_public_directory_room, create_room,
    create_space, discard_outbound_room_key, fetch_room_notification_mode, forget_room,
