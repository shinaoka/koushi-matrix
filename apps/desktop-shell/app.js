const spaces = [
  {
    id: "!space-seminars:example.org",
    shortName: "OC",
    name: "OnlineCMT seminars",
    childRoomIds: ["!springschool:example.org", "!organizers:example.org"],
  },
  {
    id: "!space-lab:example.org",
    shortName: "SL",
    name: "Soseki Lab",
    childRoomIds: ["!search-dev:example.org"],
  },
];

const rooms = [
  {
    id: "!springschool:example.org",
    name: "2027_springschool",
    isDm: false,
    unread: 8,
    parentSpaceIds: ["!space-seminars:example.org"],
  },
  {
    id: "!organizers:example.org",
    name: "organizers",
    isDm: false,
    unread: 2,
    parentSpaceIds: ["!space-seminars:example.org"],
  ...
  {
    id: "!search-dev:example.org",
    name: "matrix-sdk-search",
    isDm: false,
    unread: 1,
    parentSpaceIds: ["!space-lab:example.org"],
  },
  {
    id: "!dm-akio:example.org",
    name: "Akio",
    isDm: true,
    unread: 1,
    parentSpaceIds: [],
...
const messages = [
  {
    roomId: "!springschool:example.org",
    eventId: "$zoom-invite",
    sender: "品岡寛(椅大)",
    time: "15:04",
  ...
  },
  {
    ...
    attachmentFilename: "seminar_budget.xlsx",
    replyCount: 0,
    bot: true,
  },
  {
...
const state = {
  activeSpaceId: "!space-seminars:example.org",
  activeRoomId: "!springschool:example.org",
  threadRootEventId: "$zoom-invite",
  searchQuery: "",
  focusedEventId: null,
  composerDraft: "",
};
...
function activeSpaceName() {
  return spaces.find((space) => space.id === state.activeSpaceId)?.name ?? "Matrix Desktop";
}
