...
use matrix_desktop_state::{
    ...
    SessionState, SettingsState, SidebarModel, SpaceSummary, SyncMode, SyncState,
    ThreadAttentionState, ThreadPaneState, TimelinePaneState, TypographyDisplayProfile,
