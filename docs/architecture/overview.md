...
the user for confirmation before any bytes are downloaded. A verified download
becomes `ready`; installation and relaunch occur only after an explicit user
