...
use matrix_desktop_state::{
    ...
    NotificationSettings, PresenceKind, RecoveryRequest, RoomListFilter, RoomSummary, RoomTagKind,
    RoomTags, SasEmoji, ScheduledSendCapability, ScheduledSendHandle, ScheduledSendItem,
    SearchState, SessionInfo, SessionState, SettingsPatch, SettingsPersistenceState,
    SoftLogoutReauthState, ThemePreference, VerificationCancelReason, VerificationFlowState,
    VerificationTarget,
};
